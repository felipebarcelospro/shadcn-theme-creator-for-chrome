...
export function WaitlistDialog({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[500px] bg-background text-foreground rounded-lg overflow-hidden transition-all duration-300 ease-in-out">
        <div className="relative p-4">
          <DialogHeader className="space-y-2 mb-4">
            ...
            <DialogDescription className="text-sm text-muted-foreground">
              {!isSubmitted && "Be the first to know when our Chrome extension is ready. Enter your email to join the waitlist."}
            </DialogDescription>
          </DialogHeader>
          {!isSubmitted ? (
                ...
                <div className="bg-secondary/20 rounded-xl border-b rounded-b-none p-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Enter your email to join our exclusive waitlist</p>
                    </div>
                  </div>
                </div>
                <div className="bg-secondary/20 p-4 border-b">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Verify your email to secure your spot</p>
                    </div>
                  </div>
                </div>
                <div className="bg-secondary/20 rounded-xl rounded-t-none p-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">We'll notify you when the beta is ready</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  >
                    {form.formState.isSubmitting && (
                      <svg className="w-5 h-5 mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8V16M8 12H16"></path>
                      </svg>
                    )}                  
                    Join Waitlist
                  </Button>
            ...
            <div className="py-6 text-center animate-fade-in-up">
              <svg className="w-20 h-20 mx-auto text-primary mb-6 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                We're thrilled to have you join our waitlist. Exciting updates are coming your way soon!
              </p>
              <div className="space-y-4">
