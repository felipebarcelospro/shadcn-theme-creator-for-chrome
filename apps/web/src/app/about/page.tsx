...
export default function About() {
  return (
    <main className="container mx-auto px-4 py-8 sm:py-12 md:py-16 max-w-2xl">
      <section className="text-left mb-12 sm:mb-16 md:mb-24 relative">
        <Link href="/" passHref>
          <Button
            variant="ghost"
            size="icon"
            className="absolute -top-8 sm:-top-12 md:-top-16 left-0 rounded-full bg-secondary hover:bg-secondary/80"
          >
            <svg
        ...
        <div className="text-zinc-900">
          <Link href="https://twitter.com/feldbarcelospro" target="_blank">
            <img
              ...
              width={96}
              height={96}
              className="mb-4 w-20 sm:w-24 rounded-full transition-all hover:rotate-6 hover:bg-zinc-100 active:rotate-12 active:scale-90"
            />
          </Link>
          <h1 className="text-3xl sm:text-4xl">Hi! I'm Felipe</h1>
          ...
          <p className="pt-4 sm:pt-6 text-xs sm:text-sm text-zinc-600">Ps. <a className="text-blue-500 underline" href="https://twitter.com/felipebarcelos">Follow me on Twitter</a> for updates on my projects and insights into SaaS development.</p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
          <Card className="p-4 sm:p-6">
            <div className="flex items-center mb-2 sm:mb-4">
              <div className="bg-primary text-primary-foreground p-1 sm:p-2 rounded-full mr-2 sm:mr-4">
          ...
          <Card className="p-4 sm:p-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">Export your custom theme as a CSS file or JSON configuration with a single click.</p>
          </Card>
          <Card className="p-4 sm:p-6">
            <div className="flex items-center mb-2 sm:mb-4">
              <div className="bg-primary text-primary-foreground p-1 sm:p-2 rounded-full mr-2 sm:mr-4">
          ...
          <Card className="p-4 sm:p-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">All customizations happen locally in your browser, ensuring data privacy.</p>
          </Card>
        </div>
      </section>
