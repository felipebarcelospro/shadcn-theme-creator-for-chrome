...
export const config: Config = {
  // General
  projectName: "Shadcn/UI Theme Creator for Chrome",
  ...
  projectTagline: "Customize Your UI in Real-Time with Shadcn/UI Theme Creator for Chrome",
  ...
  features: [
    {
      ...
      description: "Instantly recognizes Shadcn/UI UI compatible websites, streamlining your workflow.",
  ...
  faq: [
    {
      question: "What is Shadcn/UI Theme Creator for Chrome?",
      answer: "Shadcn/UI Theme Creator for Chrome is a Chrome extension that allows real-time customization and preview of Shadcn/UI UI themes, enhancing your web development workflow."
    },
    {
      question: "How does Shadcn/UI Theme Creator for Chrome work?",
      answer: "It integrates with your browser, allowing you to modify Shadcn/UI UI theme variables on-the-fly and see changes instantly on any website using Shadcn/UI UI."
    },
    {
      question: "Is Shadcn/UI Theme Creator for Chrome free to use?",
      answer: "Yes, Shadcn/UI Theme Creator for Chrome is completely free. You can download it from the Chrome Web Store and start customizing immediately."
    },
    {
    ...
    {
      question: "Can I use Shadcn/UI Theme Creator for Chrome with any website?",
      answer: "Shadcn/UI Theme Creator for Chrome works with any website that uses Shadcn/UI UI. It automatically detects compatible sites and enables customization."
    },
    {
      question: "Does Shadcn/UI Theme Creator for Chrome support dark mode?",
    ...
    {
      question: "How often is Shadcn/UI Theme Creator for Chrome updated?",
      answer: "We regularly update Shadcn/UI Theme Creator for Chrome to ensure compatibility with the latest Shadcn/UI UI versions and to add new features based on user feedback."
    },
    {
      question: "Can I save multiple custom themes?",
      answer: "Yes, Shadcn/UI Theme Creator for Chrome allows you to save and manage multiple custom themes, making it easy to switch between different designs."
    },
    {
      question: "Is Shadcn/UI Theme Creator for Chrome suitable for beginners?",
      answer: "Absolutely! Shadcn/UI Theme Creator for Chrome is designed to be user-friendly, making it accessible for beginners while still offering powerful features for experienced developers."
    },
    {
      question: "How can I contribute to Shadcn/UI Theme Creator for Chrome?",
