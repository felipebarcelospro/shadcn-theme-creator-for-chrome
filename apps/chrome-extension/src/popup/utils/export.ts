 ...
 * 
 * This function is part of the Shadcn/UI Theme Customizer browser extension.
 * Shadcn/UI Theme Customizer allows you to customize and export themes for websites using Shadcn/UI UI.
 * 
...
export function exportTheme(currentTheme: ThemeVariables, originalTheme: ThemeVariables, currentMode: 'light' | 'dark'): void {
  ...
  const cssContent = `/**
 * Generated by Shadcn/UI Theme Customizer
 * https://github.com/your-username/shadcn-theme-customizer
 *
 * This theme is compatible with Shadcn/UI UI (https://ui.shadcn.com/)
 * Learn more about customizing your Shadcn/UI UI theme:
 ...
 * 3. Enjoy your customized Shadcn/UI UI theme!
 */
